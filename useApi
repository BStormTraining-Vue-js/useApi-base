...
export namespace useApi {
    export type ApiResult<T> = {data: Ref<T|undefined>, error: Ref<any>, isLoading: Ref<boolean>};
    export type ApiCallBack = (...args: any[]) => void;
    export type ApiRequest<T> = (...args: any[]) => Promise<T>;
}
